...
TEST(lista_test, test_agregar_un_elemento_adelante) {
    ...
    ASSERT_EQ(l.iesimo(0), 43);
    ASSERT_EQ(l.iesimo(1), 42);
}
...
TEST(lista_test, test_eliminar_elementos2) {
    Lista l;
    l.agregarAtras(42);
    l.agregarAtras(45);
    l.agregarAtras(43);
    ...
    ASSERT_EQ(l.longitud(), 2);   //con este test me aseguro que los casos bordes esten bien, cuando es el primero o el ultimo que quiero eliminar
    ASSERT_EQ(l.iesimo(0), 42);
    ASSERT_EQ(l.iesimo(1), 43);
}
